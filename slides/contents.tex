...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Functional Essence is Multi-Purpose}

\begin{itemize}[<+->]
\item Learn about the domain
\item Discuss with domain experts
\item Validate assumptions at an early stage

\vspace{1em}

\item Check real implementation:
\end{itemize}
